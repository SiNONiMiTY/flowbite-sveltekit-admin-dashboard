<script lang="ts">
    ...
    const sideBarToggleFn = ( status = sideBarIsVisible ) => {
        const sideBar = document.querySelector( '#sidebar' )
        const sidebarBackdrop = document.querySelector( '#sidebarBackdrop' )
        const sidebarOpenBtn = document.querySelector( '#toggleSidebarMobileHamburger' )
        const sidebarCloseBtn = document.querySelector( '#toggleSidebarMobileClose' )
    ...
    <div class="px-3 py-3 lg:px-5 lg:pl-3">
        <div class="flex items-center justify-between">
            <div class="flex items-center justify-start">
                <button on:click={() => sideBarToggleFn( sideBarIsVisible )} id="toggleSidebarMobile" aria-expanded="true" aria-controls="sidebar"
