...
<Sidebar asideClass="fixed top-0 left-0 z-20 flex flex-col flex-shrink-0 hidden w-64 h-full pt-16 font-normal duration-75 lg:flex transition-width" id="sidebar">
    <SidebarWrapper divClass="relative flex flex-col flex-1 min-h-0 pt-0 bg-white border-r border-gray-200 dark:bg-gray-800 dark:border-gray-700">
        <SidebarWrapper divClass="flex flex-col flex-1 pt-5 pb-4 overflow-y-auto">
            <SidebarWrapper divClass="flex-1 px-3 space-y-1 bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                <SidebarGroup ulClass="pb-2 space-y-2">
                    <SidebarItem
                        aClass="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700"
                        spanClass="ml-3" label="Dashboard">
                    ...
                    <SidebarDropdownWrapper
                        btnClass="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700"
                        label="Layouts">
                        <svelte:fragment slot="icon">
                ...
                <SidebarGroup ulClass="pb-2 space-y-2" borderClass="pt-3 mt-3 border-t border-gray-200 dark:border-gray-700" border>
                    <SidebarItem
                        aClass="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700"
                        spanClass="ml-3" label="GitHub Repository">
                        <svelte:fragment slot="icon">
                    ...
                    <SidebarItem
                        aClass="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700"
                        spanClass="ml-3" label="Flowbite Docs">
                        <svelte:fragment slot="icon">
                            <svg class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"
                                fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <SidebarItem
                        aClass="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700"
                        spanClass="ml-3" label="Components">
                        <svelte:fragment slot="icon">
                            <svg class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"
                                fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                <path
        ...
        <SidebarWrapper divClass="absolute bottom-0 left-0 justify-center hidden w-full p-4 space-x-4 bg-white lg:flex dark:bg-gray-800">
            <A
