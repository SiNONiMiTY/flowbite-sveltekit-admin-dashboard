...
<Sidebar asideClass="fixed top-0 left-0 z-20 flex flex-col flex-shrink-0 hidden w-64 h-full pt-16 font-normal lg:flex" id="sidebar">
    <SidebarWrapper divClass="relative flex flex-col flex-1 min-h-0 pt-0 bg-white border-r border-gray-200 dark:bg-gray-800 dark:border-gray-700">
        <SidebarWrapper divClass="flex flex-col flex-1 pt-5 pb-4 overflow-y-auto">
            <SidebarWrapper divClass="flex-1 px-3 space-y-1 bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                <SidebarGroup ulClass="pb-2 space-y-2">
                    ...
                    <SidebarDropdownWrapper
                        btnClass="flex items-center w-full p-2 text-base text-gray-900 rounded-lg group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700"
                        label="Layouts">
                        <svelte:fragment slot="icon">
                        ...
                        <SidebarDropdownItem
                            label="Stacked"
                            aClass="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100  pl-11 dark:text-gray-200 dark:hover:bg-gray-700"/>
                        <SidebarDropdownItem
                            label="Sidebar"
                            aClass="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100  pl-11 dark:text-gray-200 dark:hover:bg-gray-700"/>
                    </SidebarDropdownWrapper>
        ...
        <SidebarWrapper divClass="absolute bottom-0 left-0 justify-center hidden w-full p-4 space-x-4 bg-white lg:flex dark:bg-gray-800">
            ...
            <Popover id="settings-popover" defaultClass="px-3 py-2 text-sm font-medium text-white bg-gray-900 rounded-lg shadow-sm tooltip dark:bg-gray-700" transition={fade} params={{duration: 300}}>
                Settings page
            </Popover>
